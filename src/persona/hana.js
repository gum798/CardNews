...
export const hana = {
  ...
  appearance: {
    ...
    // (아나운서 준비하며 점 빼는 이야기). 외모가 바뀌는 이유가 스토리 안에서 설명된다.
  ...
  // ── 촬영 공간 ───────────────────────────────────────────────
  // 방송국 스튜디오가 아니라 자취방이다. 지망생이 집에서 혼자 연습하는 설정에 맞고,
  ...
  setting: {
    ...
    roomPrompt:
      ...
      'on that wall, three A4 sheets of pronunciation practice notes taped in a row at head height, slightly crooked; ' +
      ...
      'a light-wood folding desk in front of her with a closed laptop, a white ceramic mug, and a stack of printed scripts; ' +
      'a clothing rack in the far left background with a beige jacket hanging on it; ' +
  ...
  storyArc: [
    {
      ...
      beats: [
        '카메라 테스트 때 입가 점이 자꾸 신경 쓰였다는 고민',
        '지원 마감 전에 큰맘 먹고 피부과 예약',
        '시술 당일 — 생각보다 금방 끝남, 딱지 앉은 며칠',
        '떼고 난 뒤 첫 카메라 테스트',
      ],
      note: '외모 변화의 근거이자 "지망생의 준비 과정" 서사. 시청자 공감대가 가장 큰 소재.',
    },
  ],
