...
export const cloudflare = {
  ...
  // ⚠️ 장당 약 1,416뉴런(추정; 실제는 더 높다 — budget.js) — 무료 10,000/일이면 계정당 7장 이하다.
  //    그래서 브이로그당 3장(curator/vlog.js PHOTO_COUNT, 2026-09-04에 5→3)이고 재시도도 아껴야 한다.
  //    장수를 늘리려면 4b로 되돌리는 편이 낫다.
