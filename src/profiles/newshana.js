...
export default {
  ...
  topics: {
    ...
    ai: {
      ...
      scriptStyle: 'howto',
      pickCriteria:
        // ⚠️ 원래 기준이 「새 도구·기능 출시」를 명시적으로 요구해서, 결과적으로
        //    "어느 회사가 AI 기능을 냈다"류만 뽑혔다. 그 범주 12건 중 8건이 같은 슬롯
        //    꼴찌였다(p=0.0096). ai 스트림 16건 중 9건이 채널 중앙값 미만.
        //    출시 발표가 아니라 그 AI가 바꿔놓은 현장을 요구하도록 바꿨다.
        '⚠️ 그 AI가 실제로 바꿔놓은 현장이나 사람의 행동이 기사에 나오는 것만 고르세요. ' +
        '누가 어디서 무엇을 다르게 하게 됐는지가 보여야 합니다. ' +
        '출시·업데이트·공개 발표 자체는 고르지 마세요 — 화면에 보여줄 장면이 없습니다. ' +
        '시청자가 오늘 당장 따라 해볼 수 있는 것이면 더 좋습니다. ' +
